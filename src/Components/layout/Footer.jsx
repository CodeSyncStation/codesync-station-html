        ...
        <div className="row g-4 pb-4">
          ...
          <div className="col-lg-4">
            <div className="footer-middle">
              ...
              <div className="links">
                <ul className="footer-links pe-3">
            ...
            <div className="footer-right">
              ...
              <ul className="footer-address">
                ...
                <li className="phone">
                  ...
                  <a href="tell:+447388620365"> <span className="text">+44 7388 620365</span></a>
                  <a href="tell:+8801753674485">
                    <span className="text">+8801753674485 </span>
                  </a>
                </li>
                <li className="email">
                  <span className="hl">E-mail:</span>
                  <a href="mailto:codesyncstation@gmail.com"
              ...
              <div className="socials">
                <a
                  target="_blank"
                  href="https://www.facebook.com/profile.php?id=61559705190112"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                ...
                <a
                  target="_blank"
                  href="https://www.linkedin.com/company/codesync-station/"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
