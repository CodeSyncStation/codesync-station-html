...
export default function EditModal({ show, setShow, user }) {
  ...
  const handleEdit = async() => {
    if (!fullName || !email || !phone) return toast.error("Please fill all the fields below")
    ...
    try {
     await updateUserInfo({ iri: user["@id"], data: userInfo })
  ...
  return (
    <Modal show={show} onHide={handleClose} animation centered>
      ...
      <Modal.Footer className="border-0 pt-0">
        ...
        <button className="btn-dashboard" onClick={handleEdit}>
          Update
        </button>
      </Modal.Footer>
    </Modal>
