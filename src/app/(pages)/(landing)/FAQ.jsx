        ...
        <div className="faq-row">
          <div className="faq-column">
            ...
            <div className="faq-item" data-aos="fade-left" data-aos-delay="200">
              ...
              <h4>How long will it take to complete my website?
              </h4>
              <p>The timeline depends on the complexity and size of the project. Simple websites may take 5-7 days, while larger, custom projects could take 2-4 weeks. We'll discuss the timeframe during our initial consultation.
              </p>

            </div>

            <div className="faq-item" data-aos="fade-left" data-aos-delay="600">
              <h4>Will my website be mobile-friendly?
              </h4>
              <p>If you have more than one property to manage, you can simply add an extra property by clicking on your email address on the top-left corner of the screen.</p>

            </div>
            <div className="faq-item" data-aos="fade-left" data-aos-delay="700">
              <h4>Do you offer domain and hosting services?
              </h4>
              <p>If you get a lot of travellers coming to your hotel as a group, then we recommend using the Group functionality.</p>
          ...
          <div className="faq-column">
            ...
            <div className="faq-item" data-aos="fade-left" data-aos-delay="500">
              <h4>Can you help improve an existing website?
              </h4>
              <p>Absolutely! I can help optimize the performance, enhance the design, improve SEO, and implement new features on your current website.
              </p>

            </div>

            <div className="faq-item" data-aos="fade-left" data-aos-delay="300">
              <h4>Do you provide website maintenance after development?</h4>
              <p>Yes, I offer maintenance packages to ensure your website stays updated, secure, and performs optimally. You can choose ongoing support or request help when needed.
              </p>

            </div>

            <div className="faq-item" data-aos="fade-left" data-aos-delay="100">
              <h4>What is the development process for building my website?</h4>
              <p>The process starts with gathering your requirements and understanding your goals. Afterward, I’ll design the UI/UX, develop the website using the MERN stack (or other required tech), and perform testing. Once approved, I will deploy the site and offer ongoing support.
              </p>
