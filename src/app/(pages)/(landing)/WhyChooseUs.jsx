    ...
    <section className="why-choose-us py-5">
      <div className="container">
        ...
        <div className="section-title">
          ...
          <h2 className="title">
          Don’t just code your way forward, Codezzi your way to the top.
          </h2>
        </div>
        <div className="row mt-4">
          <div className="col-lg-3 col-md-6 text-center mb-4">
            <div className="choose-card p-4">
              ...
              <p>
                Codezzi utilizes the latest technology to keep you ahead in the industry. Benefit from solutions that streamline processes, driving your business to new heights.
              </p>
            </div>
          </div>
          <div className="col-lg-3 col-md-6 text-center mb-4">
          ...
          <div className="col-lg-3 col-md-6 text-center mb-4">
            <div className="choose-card p-4">
              ...
              <p>
                With a portfolio of successful projects across various industries, Codezzi has a proven track record of delivering high-quality solutions that meet and exceed client expectations.
              </p>
            </div>
          </div>
        </div>
